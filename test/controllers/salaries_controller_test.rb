...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { tax: @salary.tax, total: @salary.total, vat: @salary.vat } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { tax: @salary.tax, total: @salary.total, vat: @salary.vat } }
